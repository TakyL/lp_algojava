...
public class Liste {	//Tableau de liste A/.- => B/-...  en gros on associe chaque lettre à son code
	Lettre Lettre_ref;//Lettre référence
	...
	public Liste RetourneAuDebut()//Remonte au premier élément et repointe dessus de la liste [non testé]
	{
	...
	public void AffichageDebut()	//Affiche tous les éléments de la liste
	{
		System.out.println("Affichage Descendant");
		System.out.println(getLettre_ref());	//Affiche l'élément actuel [cf AffichageFin]
	...
	public void AffichageFin()	//Affiche tous les éléments de la liste
	{
		System.out.println("Affichage AScendant");
		setLettre_ref(getSuivant().getLettre_ref());	//Null sinon 
		System.out.println(getLettre_ref());	//Affiche l'élément actuel
		while(getPrec()!=null)
		{	
