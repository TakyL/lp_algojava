...
public class Conversion {
	...
	public Conversion(Liste l) {
		...
		//NOTE: Toujours vérifier la position car pour l'instant, getsuivant() a tendance a être la lettre actuelle et que du coup la lettre actuelle ait de fortes chances d'être null
	public String recherchecode(String mot)	//Recherche le code binaire d'un caractère associé
	{
		...
		//l.afficher_position();
			do
			{
					//Note : Faire remonter la piste de lecteur au tout debut à chaque nouvelle recherche dans la liste 
				...
				else	//Si on commence à la fin de la liste
				{
